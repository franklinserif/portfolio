<template>
  <div id="console">
    ...
    <button id="start-button" class="" @click="startGame">start-game</button>

    <!-- Game Over -->
    <div id="game-over" class="hidden">
      <span
        class="text-greenfy bg-bluefy-dark h-12 flex items-center justify-center"
        >GAME OVER!</span
      >
      <button
        class="text-menu-text text-sm flex items-center justify-center w-full py-6 hover:text-white"
        @click="startAgain"
      >
        start-again
      </button>
    ...
    >
      <div>
        <div id="instructions" class="text-sm text-labels text-white">
          ...
          >
            <button id="console-button" class="button-up" @click="move('up')">
              <img src="/icons/arrow-button.svg" alt="" />
            </button>
            ...
            <div class="grid grid-cols-3 gap-1">
              <button
                ...
                @click="move('left')"
              >
                <img src="/icons/arrow-button.svg" alt="" class="-rotate-90" />
              </button>
              ...
              <button
                ...
                @click="move('down')"
              >
                <img src="/icons/arrow-button.svg" alt="" class="rotate-180" />
              </button>
